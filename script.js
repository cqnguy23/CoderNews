...
function getUrl() {
 let url = "https://newsapi.org/v2/top-headlines?apiKey=2a25c01929c345b4a768b0154c14ff98&country=us";
...
function renderArticles(article) {
    return `
        <div onmouseover="this.style.backgroundColor='beige';" onmouseout="this.style.backgroundColor='';" class="hover" style="display: flex; flex-direction: column; align-items: center; height: 80vh; width: 90vh; margin-top: 40px; border: 1px solid black">
            <h4 style= "width: 480px; margin-top: 15px"> ${article.title} </h4>
           <img src="${article.urlToImage}" width = 480px>
